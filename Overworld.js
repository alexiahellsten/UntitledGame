class Overworld {
 ...
 init() {
    ...
    this.map.startCutscene([
        { executor: "hero", type: "walk", direction: "left"},
        { executor: "hero", type: "walk", direction: "down"},
        { executor: "hero", type: "walk", direction: "left"},
        { executor: "panda", type: "walk", direction: "up"},
        { executor: "panda", type: "stand", direction: "right", time: 800},
    ])
